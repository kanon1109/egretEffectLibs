...
var FlameGunEffectTest = (function (_super) {
    ...
    FlameGunEffectTest.prototype.onAddToStage = function (event) {
    ...
    FlameGunEffectTest.prototype.touchHandler = function (event) {
    ...
    FlameGunEffectTest.prototype.touchEndHandler = function (event) {
        this.isTouched = false;
        this.fge.status = FlameGunEffect.STOP;
    };
    FlameGunEffectTest.prototype.touchBeginHandler = function (event) {
    ...
    FlameGunEffectTest.prototype.loop = function (event) {
...
__reflect(FlameGunEffectTest.prototype, "FlameGunEffectTest");
//# sourceMappingURL=FlameGunEffectTest.js.map