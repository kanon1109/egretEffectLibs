...
var BlackHoleEffectTest = (function (_super) {
    ...
    BlackHoleEffectTest.prototype.onAddToStage = function (event) {
        this.ary = [];
        this.holeList = [];
    ...
    BlackHoleEffectTest.prototype.btnClickHandler = function (event) {
        event.stopPropagation();
        this.addObj();
    };
    BlackHoleEffectTest.prototype.loop = function (event) {
    ...
    BlackHoleEffectTest.prototype.mouseClickHandler = function (event) {
    ...
    BlackHoleEffectTest.prototype.attenuationHandler = function (event) {
        //这里可以将黑洞的显示效果慢慢缩小。
        var blackHole = event.currentTarget;
        var bhMc = blackHole.useData;
        egret.Tween.get(bhMc).to({ scaleX: 0, scaleY: 0 }, 1000);
    };
    BlackHoleEffectTest.prototype.blackHoleOverHandler = function (event) {
        //黑洞完全消失，可以将黑洞显示对象删除
        var blackHole = event.currentTarget;
        blackHole.destroy();
        var length = this.holeList.length;
    ...
    BlackHoleEffectTest.prototype.inHoleHandler = function (event) {
        var dObj = event.dObj;
    ...
    BlackHoleEffectTest.prototype.addObj = function () {
    ...
    BlackHoleEffectTest.prototype.randnum = function (a, b) {
        return Math.random() * (b - a) + a;
    };
    return BlackHoleEffectTest;
}(egret.Sprite));
__reflect(BlackHoleEffectTest.prototype, "BlackHoleEffectTest");
