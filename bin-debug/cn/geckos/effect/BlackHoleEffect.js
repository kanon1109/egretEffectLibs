    ...
    (function (geckos) {
        ...
        (function (effect) {
            var BlackHoleEffect = (function (_super) {
                 ...
                 */
                BlackHoleEffect.prototype.addHole = function (holePosX, holePosY) {
                 ...
                 * @param	ary		物质列表
                 */
                BlackHoleEffect.prototype.addSubstanceList = function (ary) {
                    this.subList = ary;
                };
                /**
                 * 更新
                 */
                BlackHoleEffect.prototype.update = function () {
                    if (!this.isStart)
                        return;
                    if (!this.subList)
                        return;
                 ...
                 * @param	container
                 */
                BlackHoleEffect.prototype.setDebugContainer = function (c) {
                    this.debugSprite = c;
                };
                /**
                 * 销毁
                 */
                BlackHoleEffect.prototype.destroy = function () {
                    this.subList = null;
                    if (this.debugSprite)
                 ...
                 * 调试
                 */
                BlackHoleEffect.prototype.debug = function () {
                    if (!this.debugSprite)
                        return;
                    if (!this.isStart)
                        return;
                 ...
                 * @return	2点之间的距离
                 */
                BlackHoleEffect.prototype.mathDistance = function (x1, y1, x2, y2) {
                    return Math.sqrt((x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1));
                };
                return BlackHoleEffect;
            }(egret.EventDispatcher));
            effect.BlackHoleEffect = BlackHoleEffect;
            __reflect(BlackHoleEffect.prototype, "cn.geckos.effect.BlackHoleEffect");
            ...
            __reflect(BlackHoleEvent.prototype, "cn.geckos.effect.BlackHoleEvent");
