    ...
    (function (geckos) {
        ...
        (function (effect) {
            ...
            var SlotsEffect = (function () {
                 ...
                 */
                function SlotsEffect(curIndex, maxIndex, loop, delay, gapIndex) {
                 ...
                 * @param	delay	运行间隔
                 */
                SlotsEffect.prototype.addTimer = function (delay) {
                    if (!this.timer) {
                 ...
                 * 计时器暂停
                 */
                SlotsEffect.prototype.stop = function () {
                    if (!this.timer)
                        return;
                 ...
                 * 计时器开始
                 */
                SlotsEffect.prototype.start = function () {
                    if (!this.timer)
                        return;
                    this.stop();
                    this.timer.start();
                 ...
                 * @param	reverse		是否逆运行
                 */
                SlotsEffect.prototype.show = function (targetIndex, reverse) {
                ...
                SlotsEffect.prototype.timerHandler = function (event) {
                    if (!this.funList)
                        return;
                    //索引轮回
                    if (!this.reverse) {
                 ...
                 * @return  修正后的数字
                 */
                SlotsEffect.prototype.fixNumber = function (num, min, range) {
                    num %= range;
                    if (num < min)
                        return num + range;
                    return num;
                 ...
                 * @param	fun		方法引用
                 */
                SlotsEffect.prototype.push = function (fun, thisObj) {
                    if (!this.funList)
                        return;
                 ...
                 * @param	fun		方法引用
                 */
                SlotsEffect.prototype.splice = function (fun) {
                    if (!this.funList)
                        return;
                 ...
                 * 销毁
                 */
                SlotsEffect.prototype.destroy = function () {
                    if (this.timer) {
                    ...
                    if (this.thisList) {
                        var length = this.thisList.length;
                        for (var i = length - 1; i >= 0; i -= 1) {
                ...
                Object.defineProperty(SlotsEffect.prototype, "curIndex", {
                    /**
                     * 当前索引
                     */
                ...
                Object.defineProperty(SlotsEffect.prototype, "delayAdd", {
                    /**
                ...
                Object.defineProperty(SlotsEffect.prototype, "randomIndex", {
                    /**
                     * 随机索引
                     */
            ...
            effect.SlotsEffect = SlotsEffect;
            __reflect(SlotsEffect.prototype, "cn.geckos.effect.SlotsEffect");
