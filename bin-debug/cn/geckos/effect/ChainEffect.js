    ...
    (function (geckos) {
        ...
        (function (effect) {
            ...
            var ChainEffect = (function () {
                 ...
                 * @param	y	起始点y坐标
                 */
                ChainEffect.prototype.move = function (x, y) {
                    this.prevPos.x = x;
                    this.prevPos.y = y;
                };
                /**
                 ...
                 */
                ChainEffect.prototype.update = function (targetX, targetY) {
                 ...
                 * 更新线条状态
                 */
                ChainEffect.prototype.updateLine = function () {
                    if (!this.lineAry)
                        return;
                 ...
                 * 清除
                 */
                ChainEffect.prototype.clear = function () {
                    var line;
                 ...
                 * 销毁
                 */
                ChainEffect.prototype.destroy = function () {
                    this.clear();
                    this.prevPos = null;
                    this.curPos = null;
                    this.parent = null;
                ...
                Object.defineProperty(ChainEffect.prototype, "lineColor", {
                    /**
                     * 设置线条颜色
                     */
                ...
                Object.defineProperty(ChainEffect.prototype, "lineSize", {
                    /**
                     * 线条粗细
                     */
            ...
            __reflect(ChainEffect.prototype, "cn.geckos.effect.ChainEffect");
