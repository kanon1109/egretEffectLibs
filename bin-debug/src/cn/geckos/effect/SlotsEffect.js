    ...
    (function (geckos) {
        ...
        (function (effect) {
            ...
            var SlotsEffect = (function () {
                ...
                var __egretProto__ = SlotsEffect.prototype;
                /**
                 * 添加计时器
                 * @param	delay	运行间隔
                 */
                 ...
                 * @param	reverse		是否逆运行
                 */
                __egretProto__.show = function (targetIndex, reverse) {
                 ...
                 * @return  修正后的数字
                 */
                __egretProto__.fixNumber = function (num, min, range) {
                    num %= range;
                    if (num < min)
                        return num + range;
                    return num;
                 ...
                 * @param	fun		方法引用
                 */
                __egretProto__.push = function (fun, thisObj) {
                    if (!this.funList)
                        return;
                 ...
                 * @param	fun		方法引用
                 */
                __egretProto__.splice = function (fun) {
                    if (!this.funList)
                        return;
                ...
                Object.defineProperty(__egretProto__, "delayAdd", {
                    /**
                     * timer延迟的增量 用于慢速滚动模式中的速度
                     */
                    get: function () {
                        return this._delayAdd;
                    },
                    set: function (value) {
                ...
                Object.defineProperty(__egretProto__, "randomIndex", {
                    /**
                     * 随机索引
                     */
                    get: function () {
            ...
            SlotsEffect.prototype.__class__ = "cn.geckos.effect.SlotsEffect";
